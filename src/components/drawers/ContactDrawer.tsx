...
export const ContactDrawer: React.FC = () => {
  ...
  const platformConfig = selectedContact.platform ? getPlatformConfig(selectedContact.platform as any) : null;
              ...
              >
                  ...
                  {selectedContact.location && (
                    <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{selectedContact.location}</p>
                      </div>
                    </div>
                  )}
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">
                      {selectedContact.interaction_count}
                    </div>
                  ...
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      ${selectedContact.total_value.toLocaleString()}
                    </div>
                  ...
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">
                      {(selectedContact.sentiment_score * 100).toFixed(0)}%
                    </div>
                ...
                {selectedContact.bio && (
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">{selectedContact.bio}</p>
                  </div>
                )}
              </motion.div>
            )}
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                      ...
                      <p className="text-sm text-green-800">
                        This contact was enriched on {selectedContact.enriched_at && formatTimeAgo(new Date(selectedContact.enriched_at))} 
                        using {selectedContact.enrichment_source}.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-gray-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">{selectedContact.enrichment_source}</p>
                      </div>
                      <div className="p-3 bg-gray-50 rounded-lg">

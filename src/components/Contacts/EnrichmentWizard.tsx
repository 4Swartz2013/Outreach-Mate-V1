...
interface EnrichmentWizardProps {
  contact: Contact;
  onClose: () => void;
  onEnrich: (source: string, fields: string[]) => void;
}
...
export const EnrichmentWizard: React.FC<EnrichmentWizardProps> = ({ 
  contact, 
  onClose, 
  onEnrich 
}) => {
  ...
  const handleStartEnrichment = () => {
    onEnrich(selectedSources[0], selectedFields);
  };
          ...
          <div className="space-y-4">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Choose which data sources to use for enriching {contact.full_name}'s profile
              </p>
            </div>
